Feature: Admin Dashboard
  ...
  Scenario: Admin can add Electronic product
    ...
    Given the admin is login with email "lujain@gmail.com" and password "lujain"
    When the admin update an Interior product who has id "4", newname "yellolight", newprice "35$", newavailability "yes", newcategory "Interior", and newimage "yellolight.jpeg"
    Then the admin successfully update the Interior product

  Scenario: Admin can update Exterior product
    Given the admin is login with email "lujain@gmail.com" and password "lujain"
    When the admin update an Exterior product who has id "5", newname "orangelight", newprice "35$", newavailability "yes", newcategory "Exterior", and inewmage "orangelight.jpg"
    Then the admin successfully update the Exterior product

  Scenario: Admin can update Electronic product
    Given the admin is login with email "lujain@gmail.com" and password "lujain"
    When the admin update an Electronic product who has id "6", newname "bluelight", newprice "35$", newavailability "yes", newcategory "Electronic", and newimage "bluelight"
...
Then admin can delete product
  ...
  Scenario: Admin can View Customer accounts
    ...
    Then  can View Customer account
     ...
     Given the admin is login with email "lujain@gmail.com" and password "lujain"
    When  Admin can Schedule  appointment with  date "4-4-2023", time "2:00"
    ...
    Then Admin can view installation appointments
     ...
     Given the admin is login with email "lujain@gmail.com" and password "lujain"
     When Admin can update appointment from date "4-4-2023", time "3:00" to date "4-4-2023", time "4:00" 
    Then Admin can update appointment successfully
     ...
     Given the admin is login with email "lujain@gmail.com" and password "lujain"
    When  Admin can delete  appointment date "4-4-2023", time "4:00"
